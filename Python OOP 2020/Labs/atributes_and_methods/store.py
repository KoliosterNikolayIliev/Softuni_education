class Store:
    ...
    def __init__(self: str, name, type, capacity):
        self.name = name
        self.type = type
    ...
    def can_remove_ammont_item_with_amount(self, item_name, amount):
    ...
    def remove_item(self, item_name, amount):
        if not self.can_remove_ammont_item_with_amount(item_name, amount):
